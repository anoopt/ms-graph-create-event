 ...
 */
import { stringIsNullOrEmpty, mergeOptions, combine, objectDefinedNotNull, isUrlAbsolute, extend, mergeHeaders } from '@pnp/common';
...
class MapCacheManager {
    ...
    getAccessToken(realm, cacheKey) {
        return this.map.get(this.buildKey(realm, cacheKey));
    }
    setAccessToken(realm, cacheKey, token) {
        this.map.set(this.buildKey(realm, cacheKey), token);
    }
    buildKey(realm, cacheKey) {
        return `${realm}:${cacheKey}`;
    }
}
const tokenCache = new MapCacheManager();
function validateProviderHostedRequestToken(requestToken, clientSecret) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            ...
            verify(requestToken, secret, (err, decoded) => {
...
function getTokenInternal(params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const r = yield fetch(params.stsUri, {
            body: body.join("&"),
            headers: {
...
class ProviderHostedRequestContext {
    constructor(siteUrl, clientId, clientSecret, realm, refreshToken, stsUri, cacheKey) {
    ...
    static create(siteUrl, clientId, clientSecret, spAppToken) {
        return __awaiter(this, void 0, void 0, function* () {
            const payload = yield validateProviderHostedRequestToken(spAppToken, clientSecret);
    ...
    getAddInOnlyConfig() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getConfigOptions(yield getAddInOnlyAccessToken(this.siteUrl, this.clientId, this.clientSecret, this.realm, this.stsUri));
        });
    }
    getUserConfig() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getConfigOptions(yield getUserAccessToken(this.siteUrl, this.clientId, this.clientSecret, this.refreshToken, this.realm, this.stsUri, this.cacheKey));
        });
    }
    getConfigOptions(token) {
        return {
            headers: {
...
class AdalFetchClient {
    constructor(_tenant, _clientId, _secret, _resource = "https://graph.microsoft.com", _authority = "https://login.windows.net") {
    ...
    acquireToken() {
        return new Promise((resolve, reject) => {
            this.authContext.acquireTokenWithClientCredentials(this._resource, this._clientId, this._secret, (err, token) => {
                if (err) {
                    reject(err);
                }
                else {
...
class NodeFetchClient {
     ...
     */
    constructor(retryCount = 3, retryInterval = 3000, minRetryInterval = 3000, maxRetryInterval = 90000) {
    ...
    fetch(url, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const wrapper = (retryData) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if (["ETIMEDOUT", "ESOCKETTIMEDOUT", "ECONNREFUSED", "ECONNRESET"].indexOf(err.code.toUpperCase()) > -1) {
                        Logger.write(`Attempt #${retry.retryCount} - Retrying error code: ${err.code}...`, 0 /* Verbose */);
                        // If current amount of retries is less than the max amount,
                        // try again
                        if (this.shouldRetry(retry)) {
                            yield this.delay(retry.retryInterval);
                            return yield wrapper(retry);
                        }
                    }
                    throw err;
                }
            });
            return yield wrapper(null);
        });
    }
    delay(ms) {
        return __awaiter(this, void 0, void 0, function* () {
 ...
 */
class AdalCertificateFetchClient {
    /**
     *
     ...
     */
    constructor(_tenant, _clientId, _thumbprint, _privateKey, _resource = "https://graph.microsoft.com", _authority = "https://login.windows.net", _fetchClient = new NodeFetchClient()) {
        this._tenant = _tenant;
        this._clientId = _clientId;
    ...
    fetch(url, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = yield this.acquireToken();
            options.headers.set("Authorization", `${token.tokenType} ${token.accessToken}`);
            return yield this._fetchClient.fetch(url, options);
        });
    }
    acquireToken() {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                this._authContext.acquireTokenWithClientCertificate(this._resource, this._clientId, this._privateKey, this._thumbprint, (err, token) => {
                    if (err) {
                        reject(err);
                        return;
                    }
 ...
 */
class SPFetchClient {
    constructor(siteUrl, _clientId, _clientSecret, authEnv = SPOAuthEnv.SPO, _realm = "", _fetchClient = new NodeFetchClient()) {
        this.siteUrl = siteUrl;
        this._clientId = _clientId;
    ...
    fetch(url, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const realm = yield this.getRealm();
            const authUrl = yield this.getAuthUrl(realm);
            const token = yield getAddInOnlyAccessToken(this.siteUrl, this._clientId, this._clientSecret, realm, authUrl);
    ...
    getRealm() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const r = yield this._fetchClient.fetch(url, {
                "headers": {
                    "Authorization": "Bearer ",
                },
                "method": "POST",
            });
            const data = r.headers.get("www-authenticate") || "";
    ...
    getAuthUrl(realm) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const r = yield this._fetchClient.fetch(url, { method: "GET" });
...
export { SPOAuthEnv, ProviderHostedRequestContext, setProxyUrl, AdalFetchClient, AdalCertificateFetchClient, BearerTokenFetchClient, NodeFetchClient, SPFetchClient };
